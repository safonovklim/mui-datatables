...
class Example extends React.Component {
  ...
  render() {
    ...
    const columns = ["Name", "Title", "Location",  "Value", "Value Two"];
    ...
    const options = {
      ...
      filterType: 'checkbox',
      responsive: 'stacked',
      forcedPageNumber: this.state.page
    };
    ...
    return (
      <div>
        ...
        <br/>
        <br/>
        <input type="number" value={this.state.page} onChange={this.setPageNumber} min={0}/>
      </div>
    );
